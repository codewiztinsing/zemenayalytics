        ...
        tasks = [
            {
                ...
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_views_hourly",
                "schedule": hourly_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Views - Daily",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_views_daily",
                "schedule": daily_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Views - Weekly",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_views_weekly",
                "schedule": weekly_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Views - Monthly",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_views_monthly",
                "schedule": monthly_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Views - Yearly",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_views_yearly",
                "schedule": yearly_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Creations - Daily",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_creations_daily",
                "schedule": daily_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Creations - Monthly",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_creations_monthly",
                "schedule": monthly_schedule,
                "enabled": True,
            },
            {
                "name": "Aggregate Blog Creations - Yearly",
                "task": "apps.analytics.tasks.time_series_aggregation.aggregate_blog_creations_yearly",
                "schedule": yearly_schedule,
                "enabled": True,
            },
        ]
